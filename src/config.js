...
export const HDR_ENVIRONMENTS = {
  ...
  green_moss_undergrowth: { label: "Musgo con luz", file: "exr/green_moss_undergrowth_env.exr", format: "exr", category: "green" },
  ...
  aland_lichen: { label: "Textura de Åland", file: "exr/aland_lichen_env.exr", format: "exr", category: "green" },
  ...
  golden_door: { label: "Puerta Hogdalen dorada", file: "exr/golden_door_env.exr", format: "exr", category: "warm" },
  sunlit_foliage: { label: "Planta al sol", file: "exr/sunlit_foliage_env.exr", format: "exr", category: "green" },
  autumn_canopy: { label: "Arboles otoño Hogdalen", file: "exr/autumn_canopy_env.exr", format: "exr", category: "warm" },
  ...
  dark_mudflat: { label: "Textura lago congelado Alvsjö", file: "exr/dark_mudflat_env.exr", format: "exr", category: "neutral" },
  muddy_shore: { label: "Orilla lago congelado Alvsjö", file: "exr/muddy_shore_env.exr", format: "exr", category: "neutral" },
  blue_frost_window: { label: "Ventana con escarcha azul", file: "exr/blue_frost_window_env.exr", format: "exr", category: "winter" },
  frost_rosehips: { label: "Ventana con escarcha y flores congeladas", file: "exr/frost_rosehips_env.exr", format: "exr", category: "winter" },
  ...
  teal_orange_abstract: { label: "Agua turquesa y naranja Cancún", file: "exr/teal_orange_abstract_env.exr", format: "exr", category: "water" },
